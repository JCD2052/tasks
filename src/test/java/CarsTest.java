...
public class CarsTest extends BaseTest {
    ...
    public void carsTest() throws IOException {
        ...
        CarInfo firstCar = homePage.getHeaderMenu().goToResearchPage().recieveInfo(trimPosition);
        ...
        comparePage.compareCars(firstCar, secondCar);
        ResultPage resultPage = comparePage.resultPage;
